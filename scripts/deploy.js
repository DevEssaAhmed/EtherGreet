...
async function main() {
  ...
  await contract.connect(from1).buyEther("from1", "Thanks for buying", amount);
  await contract
    .connect(from2)
    .buyEther("from2", "Thanks for appreciating", amount);
  await contract.connect(from3).buyEther("from3", "Thanks for buying", amount);
